  ...
  return (
    <div className={classes.scroll}>
      ...
      <Row justify="end" span={24}>
          ...
          >
            <>
              ...
              <Form.Item
                ...
                name="sponsorType"
                rules={[
                  { required: true, message: "SponserType field is empty" },
                ]}
              >
              ...
              >
                <select allowClear placeholder="select the year">
              ...
              <Form.Item label="Priority :" name="priority">
                <select allowClear placeholder="select the Priority">
        ...
        >
          Are you sure you want to delete this Sponsor category and all
          sponsors?
        </Modal>
        ...
        <Col
          offset={20}
          style={{ padding: "1rem", paddingRight: "1rem !important" }}
        >
          {" "}
          <Button
      ...
      {sponsorsData.map((item) => {
        ...
        return (
          ...
          <Row justify="left" style={{ padding: "1rem" }}  scroll={{ x: 1500, y: 300 }} >
            <Col span={20}>
              <div
                style={{
                  display: "flex",
            ...
            >
              ...
              >
                ...
                <Form.Item label="  Sponser's Image URL" name="sponsorImg">
                  <Input
                    type="text"
                    placeholder="Enter the  Sponser's Image Url"
                  />
                </Form.Item>
