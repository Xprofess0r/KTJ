...
function Event(props) {
  ...
  const columns = [
    ...
    {
      title: "KTJ ID of GameFest's Head ",
      dataIndex: "headKtjId",
      key: "headKtjId",
    },
    {
      ...
      render: (actionIndex) => {
        ...
        return (
          <Space justify="space-between">
            <Tooltip placement="bottom" title="Delete Gamefest">
              <DeleteOutlined
                color="primary"
                onClick={() => {
            ...
            <DownloadCsv
                      ...
                      .map((team) =>
                        team.members?.map((member, idx) => {
                          return {
                            ...
                            ktjID: member.ktjID,
                            ign: team.ign[idx],
                            in_game_id: team.in_game_id[idx],
                            email: member.email,
                            phone: member.phone,
              ...
              headers={[
                ...
                { label: "In-Game Name", key: "ign" },
                { label: "In-Game ID", key: "in_game_id" },
  ...
  return (
    <>
      <Row justify="end" span={24}>
        ...
        <Modal
          title={<Row justify="center">Add New Gamefest</Row>}
          visible={showModal}
          width={900}
          footer={<div></div>}
          onCancel={() => {
        ...
        >
          ...
          >
            ...
            <Form.Item
              label="registration_link"
              name="registration_link"
              rules={[{ required: true, message: "Reg link is empty" }]}
            >
              <Input
                required
                type="text"
            ...
            <Form.Item
              label="Maximum Limit"
              name="max"
              rules={[{ required: true, message: "Max is empty" }]}
            >
              <Input
                required
                type="text"
            ...
            <Form.Item
              label="Minimum Limit"
              name="min"
              rules={[{ required: true, message: "Min is empty" }]}
            >
              <Input
                required
                type="text"
        ...
        >
          Are you sure you want to delete this Gamefest ?
        </Modal>
        <Modal
          visible={showUsers}
          width={900}
