...
class signupregister extends Component {
  constructor(props) {
    super();
    this.state = {
      errors: {},
      ...
      <div className={classes.leftdiv}>
        <div className={classes.Signupmodal}>
          ...
          <div className={classes.textboxcontainer}>
             ...
             <p>Your KTJ-ID is <span id="ktjid">21AFHHDHBJFJ</span></p>
             <p>Please Note it for furture reference  </p>
             <br />
             <h1 className={classes.spam}>Explore KTJ</h1>
          </div>
        </div>
      </div>
