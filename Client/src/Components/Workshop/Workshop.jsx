...
function Event(props) {
  ...
  const columns = [
    ...
    {
      title: "Joining Link", dataIndex: "joining_link", key: "joining_link", ellipsis: true,
...

    {
      ...
      render: (actionIndex) => {
        var regi = actionIndex.registration ? (
          <CheckCircleOutlined
            style={{ color: '#52c41a' }}
            onClick={() => RegistrationHandler(actionIndex)}
          />
        ) : (
          <CloseCircleOutlined
            style={{ color: '#f5222d' }}
        ...
        var eye = actionIndex.active ? (
          <EyeOutlined
            onClick={() => ShowHideHandler(actionIndex)}
          />
        ) : (
          <EyeInvisibleOutlined
            style={{ color: '#bfbfbf' }}
        ...
        return (
          <Space justify="space-between">
            ...
            <DownloadUser title="Download Csv of Participants" filename={actionIndex.title} data={actionIndex.users} />
            <CopyToClipboard
              onCopy={() => {
